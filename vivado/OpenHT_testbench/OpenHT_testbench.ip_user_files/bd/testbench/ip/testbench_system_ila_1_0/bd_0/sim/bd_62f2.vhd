...
----------------------------------------------------------------------------------
--Command: generate_target bd_62f2.bd
--Design : bd_62f2
...
entity bd_62f2 is
  ...
  attribute CORE_GENERATION_INFO of bd_62f2 : entity is "bd_62f2,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_62f2,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=None}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of bd_62f2 : entity is "testbench_system_ila_1_0.hwdef";
end bd_62f2;

architecture STRUCTURE of bd_62f2 is
  component bd_62f2_ila_lib_0 is
  port (
    clk : in STD_LOGIC;
  ...
  end component bd_62f2_ila_lib_0;
  component bd_62f2_g_inst_0 is
  port (
    aclk : in STD_LOGIC;
  ...
  end component bd_62f2_g_inst_0;
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXIS:SLOT_1_AXIS:SLOT_2_AXIS:SLOT_3_AXIS:SLOT_4_AXIS:SLOT_5_AXIS, ASSOCIATED_RESET resetn, CLK_DOMAIN testbench_processing_system7_0_0_FCLK_CLK0, FREQ_HZ 1e+08, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0";
...
begin
  ...
  clk_1 <= clk;
  resetn_1 <= resetn;
g_inst: component bd_62f2_g_inst_0
     port map (
      aclk => clk_1,
      aresetn => resetn_1,
...
ila_lib: component bd_62f2_ila_lib_0
     port map (
      clk => clk_1,
